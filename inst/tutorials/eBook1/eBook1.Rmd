...
tutorial:
  id: "dartr.eBook1"   # pick any stable, unique string
...
if (!file.exists(p)) {
  p <- file.path("inst", "tutorials", "eBook1", "www", "reassign_ind_function.R")
}

# If running from an installed package
if (!file.exists(p)) {
  p_pkg <- system.file("tutorials/eBook1/www/reassign_ind_function.R",
                       package = "eBook1")
